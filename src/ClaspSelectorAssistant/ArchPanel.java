    ...
    private void maxillaClick (int x, int y) {
        ...
        for (tooth t : ClaspBackEnd.teethMax.keySet()) {
            ...
            if ((x > t.xLeft)  && (x < t.xRight) && (y > t.yBottom) && (y < t.yTop)) {
                ...
                gui.radioButtonClicked(ClaspBackEnd.teethDefs.get(ClaspBackEnd.teethMax.get(t))); //Click the corresponding radio button.
                gui.radioButtons.get(ClaspBackEnd.teethDefs.get(ClaspBackEnd.teethMax.get(t))).setSelected(true);
                //repaint circle
    ...
    private void mandibleClick (int x, int y) {
        ...
        for (tooth t : ClaspBackEnd.teethMan.keySet()) {
            ...
            if ((x > t.xLeft)  && (x < t.xRight) && (y > t.yBottom) && (y < t.yTop)) {
                ...
                gui.radioButtonClicked(ClaspBackEnd.teethDefs.get(ClaspBackEnd.teethMan.get(t)));
                gui.radioButtons.get(ClaspBackEnd.teethDefs.get(ClaspBackEnd.teethMan.get(t))).setSelected(true);
                //repaint circle
                /*repaint(circleX, circleY, circleW, circleH);
                circleX = x;
                circleY = y;
